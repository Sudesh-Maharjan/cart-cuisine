      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-background to-muted/40">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mb-8 animate-fade-in opacity-90">
            Discover our story, our passion for food, and the team that makes
            Savoria special.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="opacity-0">
              ...
              <p className="text-muted-foreground mb-4">
                Savoria was born from a simple idea: to create a dining
                experience that celebrates the art of good food and warm
                hospitality. Founded in 2010 by Chef Michael Reynolds, our
                restaurant began as a small bistro with a passionate team of
                five.
              </p>
              <p className="text-muted-foreground mb-4">
                Over the years, we've grown in size but remained true to our
                core values: sourcing the finest ingredients, creating dishes
                with passion and precision, and treating every guest like
                family. Our journey has been one of constant learning and
                evolution, but our commitment to culinary excellence has never
                wavered.
              </p>
              <p className="text-muted-foreground">
                Today, Savoria stands as a testament to that original vision - a
                place where traditional techniques meet contemporary
                inspiration, where every meal tells a story, and where moments
                turn into memories.
              </p>
            ...
            {[
              {
                ...
                description:
                  "We are committed to creating dishes that delight and inspire, using classic techniques and innovative approaches.",
              },
              {
                icon: <Award size={32} className="text-primary mb-4" />,
                title: "Quality Ingredients",
                description:
                  "We source the finest, freshest ingredients, working with local farmers and producers whenever possible.",
              },
              {
                icon: <Users size={32} className="text-primary mb-4" />,
                title: "Warm Hospitality",
                description:
                  "We believe in treating every guest like family, creating a welcoming atmosphere where memories are made.",
              },
              {
                icon: <Clock size={32} className="text-primary mb-4" />,
                title: "Consistency",
                description:
                  "From your first visit to your hundredth, we strive to deliver the same exceptional experience every time.",
              },
            ].map((value, index) => (
              <div
                key={index}
      ...
      <section ref={teamRef} className="py-16 bg-card/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 opacity-0">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              The talented individuals who bring passion and expertise to
              Savoria every day.
            </p>
          </div>
            ...
            {[
              {
                ...
                image:
                  "https://img.freepik.com/free-photo/young-person-intership_23-2149315589.jpg?t=st=1742100537~exp=1742104137~hmac=4ce6ea7564b9a070f46a780ddea3deebc0695d0edc7797c585bf58324e4ec2ee&w=996",
              },
              {
                ...
                image:
                  "https://img.freepik.com/free-photo/business-finance-employment-female-successful-entrepreneurs-concept-friendly-smiling-office-manager-greeting-new-coworker-businesswoman-welcome-clients-with-hand-wave-hold-laptop_1258-59122.jpg?t=st=1742100474~exp=1742104074~hmac=6a02bd0f5093b289c8dd179261bb4bbf4a01e5ef6fd2a3b184b1846a6b5c9463&w=996",
              },
              {
                name: "James Wilson",
                title: "Pastry Chef",
                ...
                image:
                  "https://img.freepik.com/free-photo/smiley-man-work-holding-laptop-posing_23-2148908835.jpg?t=st=1742100626~exp=1742104226~hmac=8173f6949d1bf5b8b405bb5b52f25f6dcb6f4d97c0d151dd3d874049240d237d&w=996",
              },
              {
                ...
                image:
                  "https://img.freepik.com/free-photo/young-businesswoman-smiling-camera_74855-1682.jpg?t=st=1742100573~exp=1742104173~hmac=f84ed328d9d244f5fb6802b51f11627dc87d8a381b37a549f101b5211e119653&w=996",
              },
              {
                name: "Thomas Chen",
                ...
                image:
                  "https://img.freepik.com/free-photo/businessman-black-suit-makes-thumbs-up_114579-15900.jpg?t=st=1742100688~exp=1742104288~hmac=768a0dc38ccd7630edd303ccc8b18ca510cd4329172e86958d537628c3d77eea&w=996",
              },
              {
                name: "Sarah Kim",
                title: "Bar Director",
                ...
                image:
                  "https://img.freepik.com/free-photo/portrait-young-woman-giving-thumbs-up_114579-77766.jpg?t=st=1742100658~exp=1742104258~hmac=e11e5cd71f577dc69c3e0d547a412825407d57c821810a101f5196087d28f93e&w=996",
              },
            ].map((member, index) => (
              <div
                key={index}
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 opacity-0">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We're honored to be part of our guests' special moments and
              memories.
            </p>
          </div>

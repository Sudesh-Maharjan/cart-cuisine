      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-gray-800 border-b border-gray-700 shadow-sm z-10">
          <div className="flex justify-between items-center px-4 py-3">
            ...
            <h1 className="text-xl font-semibold md:ml-4 text-white">
              {getPageTitle()}
            </h1>
            ...
            <div className="flex items-center space-x-4">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-80 bg-gray-800 text-white border border-gray-700">
                  ...
                  <div className="max-h-72 overflow-y-auto">
                    {notifications.length > 0 ? (
                      notifications.map(notification => (
                        <DropdownMenuItem 
                          key={notification.id}
                          className={`cursor-pointer p-3 ${notification.isRead ? '' : 'bg-gray-700/50'} hover:bg-gray-700`}
                  ...
                  <DropdownMenuSeparator className="bg-gray-700" />
                  <DropdownMenuItem className="cursor-pointer text-primary justify-center hover:bg-gray-700">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="sm" className="flex items-center space-x-2 hover:bg-gray-700">
                ...
                <DropdownMenuContent align="end" className="bg-gray-800 text-white border border-gray-700">
                  ...
                  <DropdownMenuItem onClick={() => navigate('/admin/settings')} className="hover:bg-gray-700">
